...
//credits to KGB
	...
	inline bool GetLocalizedBaseItemName(wchar_t(&szItemName)[128])
	{
		static auto GetLocalizedBaseItemName_Fn = reinterpret_cast<bool(__cdecl*)(wchar_t(&)[128], const void*, const void*)>(
			g_Pattern.Find("client.dll", "55 8B EC 56 8B 75 10 8B 4E 34 85 C9 74 44 57 8B 7D 0C 51 8B CF 8B 07 FF 10")
			);

		static auto GLocalizationProvider = reinterpret_cast<void* (__cdecl*)()>(
			g_Pattern.Find("client.dll", "A1 ? ? ? ? A8 01 75 12 83 C8 01 C7 05 ? ? ? ? ? ? ? ? A3 ? ? ? ? B8 ? ? ? ? C3")
			);

		static auto C_EconItemView_GetStaticData = reinterpret_cast<void* (__thiscall*)(void*)>(
			g_Pattern.Find("client.dll", "0F B7 41 24 50 E8 ? ? ? ? 8B C8 E8 ? ? ? ? 6A 00 68 ? ? ? ? 68 ? ? ? ? 6A 00 50 E8 ? ? ? ? 83 C4 14 C3")
			);
	...
	*/
	...
	{
		static auto C_BaseCombatWeapon_GetName = reinterpret_cast<const char* (__thiscall*)(void*)>(g_Pattern.Find("client.dll", "0F B7 81 ? ? ? ? 50 E8 ? ? ? ? 83 C4 04 83 C0 06"));
	...
	{
		static int offset = g_Pattern.Find("client.dll", "55 8B EC 66 8B ? ? 66 3B 05 ? ? ? ? 73");
	...
	{
		static int CanFireCriticalShotOffset = g_Pattern.Find("client.dll", "6A 00 68 ? ? ? ? 68 ? ? ? ? 6A 00 E8 ? ? ? ? 50 E8 ? ? ? ? 83 C4 14 C3");
	...
	{
		static int GetTFWeaponInfoFNOffset = g_Pattern.Find("client.dll", "55 8B EC FF 75 08 E8 ? ? ? ? 83 C4 04 85 C0 75 02 5D C3 56 50 E8 ? ? ? ? 83 C4 04 0F B7 F0 E8 ? ? ? ? 66 3B F0 75 05 33 C0 5E 5D C3");
	...
	{
		static auto GetWeaponSpreadFn = reinterpret_cast<float(__thiscall*)(decltype(this))>(g_Pattern.Find("client.dll", "55 8B EC 83 EC 08 56 8B F1 57 6A 01 6A 00 8B 96 ? ? ? ? 8B 86 ? ? ? ? C1 E2 06 56 68 ? ? ? ? 51"));
	...
	{
		static auto GetSpreadAnglesFn = reinterpret_cast<void(__thiscall*)(decltype(this), Vec3&)>(g_Pattern.Find("client.dll", "55 8B EC 83 EC 18 56 57 6A 00 68 ? ? ? ? 68 ? ? ? ? 6A 00 8B F9 E8 ? ? ? ? 50 E8 ? ? ? ? 8B F0 83 C4 14 85 F6 74 10 8B 06 8B CE 8B 80 ? ? ? ? FF D0 84 C0 75 02"));
	...
	{
		static auto FN = reinterpret_cast<void(__thiscall*)(CBaseEntity*, CBaseEntity*, Vec3, Vec3*, Vec3*, bool, float)>(g_Pattern.Find("client.dll", "53 8B DC 83 EC ? 83 E4 ? 83 C4 ? 55 8B 6B ? 89 6C ? ? 8B EC 81 EC ? ? ? ? 56 8B F1 57 8B 06 8B 80 ? ? ? ? FF D0 84 C0"));
	...
	__inline bool CalcIsAttackCritical()
	{
		static auto func = g_Pattern.Find("client.dll", "53 57 6A 00 68 ? ? ? ? 68 ? ? ? ? 6A 00 8B F9 E8 ? ? ? ? 50 E8 ? ? ? ? 8B D8 83 C4 14 85 DB 0F 84 ? ? ? ?");
	...
	__inline bool CalcIsAttackCriticalHelper()
	{
		...
		static FN pCalcIsAttackCriticalHelper = reinterpret_cast<FN>(g_Pattern.Find("client.dll", "55 8B EC 83 EC 18 56 57 6A 00 68 ? ? ? ? 68 ? ? ? ? 6A 00 8B F9 E8 ? ? ? ? 50 E8 ? ? ? ? 8B F0 83 C4 14 89 75 EC"));
	...
	{
		using FN = bool(__thiscall*)(CBaseCombatWeapon*);
		static FN pCalcIsAttackCriticalHelper = reinterpret_cast<FN>(g_Pattern.Find("client.dll", "55 8B EC A1 ? ? ? ? 83 EC 08 83 78 30 00 57"));
		return pCalcIsAttackCriticalHelper(this);
	}
