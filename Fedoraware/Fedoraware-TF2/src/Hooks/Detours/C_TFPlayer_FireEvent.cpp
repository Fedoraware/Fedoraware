...
{
    static auto SpawnHalloweenSpellFootsteps = reinterpret_cast<void* (__thiscall*)(CBaseEntity*, ParticleAttachment_t, int)>(g_Pattern.Find(CLIENT_DLL, "55 8B EC A1 ? ? ? ? 83 EC ? 53 8B 5D"));
