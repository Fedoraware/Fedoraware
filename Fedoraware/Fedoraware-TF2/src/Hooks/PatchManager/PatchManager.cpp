...
void CPatchManager::Init()
{
	...
	static BytePatch cloakedSpyCheckRemoval{ g_Pattern.Find("client.dll", "74 7F 8B 07 8B CF FF 90 ? ? ? ? 8B 4D F8 8B F0 8B 11 FF 92 ? ? ? ? 3B C6 74 64 8B 75 F8 8B CE 6A 39 E8 ? ? ? ? 8B C8 85 C9 74 1D 8B 01 8B 80 ? ? ? ? FF D0 84 C0 74 0F 80 BE"), {0xEB} };
