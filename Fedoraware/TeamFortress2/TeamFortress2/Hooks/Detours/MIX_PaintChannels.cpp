...
{
	return Hook.Original<FN>()(ecx, edx, endtime, Vars::Visuals::RemoveScreenOverlays.Value ? false : bIsUnderwater);	//	maybe shouldn't use this bool, but this should remove the water sound if we are removing the overlay for it
}