...
{
	if (CBaseEntity* pLocal = g_EntityCache.GetLocal(); !pLocal || !pLocal->IsAlive() || pLocal->IsAGhost()){ F::Backtrack.bFakeLatency = false; return Hook.Original<FN>()(netChannel, edx, datagram); }
