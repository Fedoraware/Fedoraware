...
namespace DrawStaticPropsHook
{
	...
	void __fastcall Hook(void* ecx, void* edx, IClientRenderable** pProps, int count, bool bShadowDepth,
...
{
	inline SEOHook::Func Func;
	using fn = void(__fastcall*)(void*, void*, const float*);
	void __fastcall Hook(void* ecx, void* edx, const float* pColor);
}
